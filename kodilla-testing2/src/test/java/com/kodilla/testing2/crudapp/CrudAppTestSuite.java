...
public class CrudAppTestSuite {
    private static final String BASE_URL = "https://annavelrudek.github.io/";
    ...
    private boolean checkTaskExistsInTrello(String taskName) throws InterruptedException {
        ...
        driverTrello.findElement(By.id("user")).sendKeys("anna.tuszynska1@gmail.com");
        driverTrello.findElement(By.id("password")).sendKeys("ania1111");
